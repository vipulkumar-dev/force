          ...
          <div className="flex flex-col w-full max-w-[1360px] mx-auto pt-[24px] pb-6 gap-6">
            ...
            {viewMode === "list" ? (
                <div className="w-full overflow-x-auto bg-primary-foreground rounded-[14px]">
                    <Table className="border-separate border-spacing-y-2 p-2 w-full min-w-full table-auto">
                        <TableHeader>
                        ...
                        <TableBody>
                            <TableRow className="bg-white border-0 mb-2 rounded-[14px] hover:bg-white hover:cursor-pointer transition-colors duration-200 ease-out">
                                ...
                                <TableCell className="px-4 py-3 rounded-tr-[14px] rounded-br-[14px] whitespace-nowrap">
                                    <div className='flex flex-row items-center gap-2 shrink-0'>
                                        <Tooltip>
                                            <TooltipTrigger asChild>
                                                <button className='bg-page-background rounded-lg hover:cursor-pointer p-3'><Image src='/icons/game/long.svg' alt='Long' width={12} height={12} /></button>
                                            </TooltipTrigger>
                                            <TooltipContent>
                                                <p>Long</p>
                                            </TooltipContent>
                                        ...
                                        <Tooltip>
                                            <TooltipTrigger asChild>
                                                <button className='bg-page-background rounded-lg hover:cursor-pointer p-3'><Image src='/icons/game/short.svg' alt='Short' width={12} height={12} /></button>
                                            </TooltipTrigger>
                                            <TooltipContent>
                                                <p>Short</p>
                                            </TooltipContent>
